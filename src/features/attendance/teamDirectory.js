export const DIRECTORY_KEY='alpha-checkin-directory-v2';
...
export function clearTeamDirectory(){try{localStorage.removeItem(DIRECTORY_KEY);localStorage.removeItem('alpha-room-overview-v2');}catch{}}
