export const DIRECTORY_KEY='alpha-checkin-directory-v1';
...
export function clearTeamDirectory(){try{localStorage.removeItem(DIRECTORY_KEY);localStorage.removeItem('alpha-room-overview-v1');}catch{}}
