  ...
  return (
    <>
      <header className="topbar">
        ...
        <div>
          <a className="hub-home" href="https://aiconclave-dashboard.pages.dev/" onClick={event => { if (dirty && !window.confirm("Return home and discard unsaved changes?")) event.preventDefault(); }}>Home</a>
